...
MODEL_IDS = ["mistralai/Mistral-7B-v0.1", "deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B", "deepseek-ai/DeepSeek-R1-Distill-Qwen-14B", "microsoft/phi-4", "google/gemma-3-4b-pt", "ibm-granite/granite-3.3-8b-base", "meta-llama/Llama-3.2-3B", "meta-llama/Llama-3.1-8B", "Qwen/Qwen3-8B", "Qwen/Qwen3-4B"]
